<template>
  <div class="pages">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <div class="cell-top">
        <el-row :gutter="20">
          <el-col><label class="el-form-item__label ">基本信息</label></el-col>
        </el-row>
      </div>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="商品名称:"><el-input v-model="form.name" placeholder="请输入名称" /></el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="商品分类:"><el-cascader :options="product_type_options" @change="changeCascader" clearable></el-cascader></el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="商品简介:"><el-input v-model="form.name" placeholder="请输入内容" /></el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <el-col>
          <el-form-item label="商品简介:">
            <el-tag :key="tag" v-for="tag in dynamicTags" closable :disable-transitions="false" @close="handleClose(tag)" style="margin-right: 10px;">{{ tag }}</el-tag>
            <el-input
              class="input-new-tag"
            ...
            <div>
              <div class="demo-image__preview">
                <div class="el-image-box" v-for="(item, index) in add_img_list" :key="index">
                  <el-image style="width: 100px; height: 100px" :src="item" :preview-src-list="add_img_list"></el-image>
                  <span class="el-image-close flex flex--align-items--center flex--justify-content--center" @click="removeImgItem(index)"><i class="el-icon-close"></i></span>
                </div>
      ...
      <div class="cell-top">
        <el-row :gutter="20">
          <el-col><label class="el-form-item__label ">价格库存</label></el-col>
        </el-row>
      </div>
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="规格:">
            <el-select v-model="curr_select_sku_type_name" placeholder="请选择" @change="changeSelectSkuType">
              <el-option label="+新增规格" value="0"><div @click="addGuigeType(3)">+新增规格</div></el-option>
              <el-option v-for="(item, index) in sku_type_options" :key="item.value" :label="item.label" :value="item.value">
      ...
      <el-row :gutter="20">
        <el-col><el-form-item label="规格信息："></el-form-item></el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="*运费：">
            <el-radio-group v-model="select_logfee">
              <el-radio :label="1" class="flex flex--align-items--center" style="margin-bottom: 10px;">
              ...
              <el-radio :label="2" class="flex flex--align-items--center">
                <div class="flex flex--align-items--center">
                  ...
                  <el-select v-model="form.value" placeholder="请选择">
                    <el-option v-for="(item, index) in temp_logfee_options" :key="item.value" :label="item.label" :value="item.value"></el-option>
                  </el-select>
                </div>
              </el-radio>
            </el-radio-group>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="市场价："><el-input placeholder="请输入市场价" v-model="form.value"></el-input></el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
      ...
      <div class="cell-top">
        <el-row :gutter="20">
          <el-col><label class="el-form-item__label">商品介绍</label></el-col>
        </el-row>
      </div>
      <el-row :gutter="20">
        <el-col>
          <el-form-item label="*商品介绍："><tinymce v-model="content" :height="300" /></el-form-item>
        </el-col>
      </el-row>
      <!-- line -->
      <div class="cell-top">
        <el-row :gutter="20">
          <el-col><label class="el-form-item__label">销售属性</label></el-col>
        </el-row>
      </div>
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="上架处理：">
            <el-radio-group v-model="select_uppro_date">
              <el-radio :label="1" class="flex flex--align-items--center" style="margin-bottom: 10px;">
                <div class="flex flex--align-items--center"><p style="margin-right: 10px;">直接上架售卖</p></div>
              </el-radio>
              <el-radio :label="2" class="flex flex--align-items--center" style="margin-bottom: 10px;">
                <div class="flex flex--align-items--center"><p style="margin-right: 10px;">等待手动上架</p></div>
              </el-radio>
      ...
      <el-row :gutter="20">
        <el-col><el-button type="primary" @click="saveFormBtn">保存</el-button></el-col>
      </el-row>
    </el-form>
    <!-- 添加规格弹框 -->
    <el-dialog title="新增规格" :visible.sync="show_dialog_visible" width="30%" :before-close="handleCloseDialog">
      <div class="flex flex--align-items--center">
...
export default {
  ...
  data() {
    return {
      ...
      imageUrl: '',
      select_logfee: 1,
      add_img_list: ['https://fuss10.elemecdn.com/8/27/f01c15bb73e1ef3793e64e6b7bbccjpeg.jpeg', 'https://fuss10.elemecdn.com/1/8e/aeffeb4de74e2fde4bd74fc7b4486jpeg.jpeg'],
      sku_type_options: [],
      temp_logfee_options: [
        {
          value: 'moren',
